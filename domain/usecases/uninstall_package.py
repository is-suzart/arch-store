...
class UninstallPackageUseCase:
    ...
    def execute(self, pkg_type: str, pkg_name: str) -> List[str]:
        if pkg_type == "pacman":
            return self.alpm_repo.get_uninstall_command(pkg_name)
        elif pkg_type == "aur":
            return self.aur_repo.get_uninstall_command(pkg_name)
        elif pkg_type == "flatpak":
            return self.flatpak_repo.get_uninstall_command(pkg_name)
        return []
